...
--
-- Host: 127.0.0.1
-- Generation Time: 31 Agu 2023 pada 10.26
...
(3, 'Contoh', '32323', 'Honda', 2018, 'Dipinjam');
...
INSERT INTO `konseling` (`id_konseling`, `username`, `tanggal_konsul`) VALUES
(3, 'eren', '2023-08-03'),
(4, 'eren', '2023-08-04'),
(5, 'helena.123', '2023-08-04');
...
INSERT INTO `kuisioner` (`id_kuisioner`, `username`, `email`, `nama_lengkap`, `tempat_lahir`, `tgl_lahir`, `jurusan`, `prodi`, `semester`, `pendidikan_terakhir`, `rekomendasi`, `status`, `no_hp`, `status_perkawinan`, `alamat`, `jenis_layanan`, `bentuk_layanan`, `soal1`, `soal2`, `soal3`, `soal4`, `soal5`, `soal6`, `jadwal`, `hal_lain`, `ppsdm`, `media`, `baca`) VALUES
(1, 'eren', '1@gmail.com', 'Eren Spautra', 'Baradatu', '0001-01-01', 'Sistem Informasi', 'Ilmu Komputer', '1', 'SMA', 'Jurusan/Prodi/Unit', 'Dosen', '1', 'Belum Menikah', '1', 'Konsultasi Anak', '1', '1', 'Sedikit mengganggu', '1', 'Sakit Kepala', '1', 'Pernah', 'Senin Pagi (jam sesuai kesepakatan)', '1', 'Teman', 'Offline (Gedung E)', 'R'),
(2, 'helena.123', 'helena@gmail.com', 'helena', 'lampung', '2001-12-04', 'jtpui', 'informatika', '7', 'SMA', 'Jurusan/Prodi/Unit', 'Dosen', '6541762458', 'Belum Menikah', 'belwis', 'Konsultasi Dewasa', '3 bln', '3 bln', 'Cukup berat', 'teman', 'Sakit Kepala', 'relaxing ', 'Belum Pernah', 'Selasa Pagi (jam sesuai kesepakatan)', 'bisa mengikuti dengan baik ', 'Dosen Wali', 'Offline (Gedung E)', 'R');
...
(7, 'eren', 3, '2023-08-31', '2023-08-31', '', 'Acara Wisuda', 'Disetujui', 'R');
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
